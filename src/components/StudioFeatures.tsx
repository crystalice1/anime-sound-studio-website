  ...
  const features = [
    {
      ...
      personImage: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?q=80&w=988&auto=format&fit=crop"
    },
    {
      icon: "🎧",
      ...
      personImage: "https://images.unsplash.com/photo-1568602471122-7832951cc4c5?q=80&w=1470&auto=format&fit=crop"
    },
    {
      icon: "🎭",
      ...
      personImage: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?q=80&w=987&auto=format&fit=crop"
    },
    {
      icon: "⚡",
      ...
      personImage: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?q=80&w=987&auto=format&fit=crop"
    },
    {
      icon: "☕",
      ...
      personImage: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?q=80&w=1470&auto=format&fit=crop"
    },
    {
      icon: "🔒",
      color: "bg-[#8A2BE2]", // anime-purple
      ...
      personImage: "https://images.unsplash.com/photo-1580489944761-15a19d654956?q=80&w=1061&auto=format&fit=crop"
    }
  ];
    ...
    <section className="py-16 px-4 md:px-8 bg-muted rounded-3xl my-12 mx-4 md:mx-8">
      <div className="max-w-7xl mx-auto">
        <div className="relative mb-16">
          <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 w-16 h-16 bg-[#8A2BE2] rounded-full flex items-center justify-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {features.map((feature, index) => (
            <FeatureCard 
              ...
              image={feature.image}
              personImage={feature.personImage}
              number={index + 1}
            />
          ))}
        </div>
    ...
    <div className="bg-background rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow group">
      ...
      <div className="p-6">
        <div className="mb-4 flex items-center">
          <div className={`mr-3 ${color} w-10 h-10 rounded-full shadow-lg flex items-center justify-center cursor-pointer hover:scale-110 transition duration-300 overflow-hidden`}>
            <img 
              src={personImage} 
              alt="Team member" 
